...
class Pessoa:
    ...
    def __str__(self):
        return f'Olá meu nome é {self.nome} e tenho {self.idade} anos, minha profissão é {self.profissao}!'
    
    @property
    def nome_idade(self):
        return f'{self.nome} por {self.idade}'
    
    def aniversario(self, anos):
        self.idade += anos

pessoa1 = Pessoa(nome = 'Caique', idade = 31, profissao = 'TI')
